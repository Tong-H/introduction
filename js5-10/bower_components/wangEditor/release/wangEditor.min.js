!function (e, t) {
    ...
    function l(e, t) {
        ...
        r && (c = r.html(), c = z(i, c), r.html(c), r.addClass("w-e-dp-title"), A.append(r));
        var a = t.list || [], s = t.type || "list", l = t.onClick || J, d = o('<ul class="' + ("list" === s ? "w-e-list" : "w-e-block") + '"></ul>');
    ...
    function _(e, t) {
        var n = e.clipboardData || e.originalEvent && e.originalEvent.clipboardData, i = void 0, o = void 0;
        if (null == n ? i = window.clipboardData && window.clipboardData.getData("text") : (i = n.getData("text/plain"), o = n.getData("text/html")), !o && i && (o = "<p>" + a(i) + "</p>"), o) {
            var A = o.split("</html>");
            return 2 === A.length && (o = A[0]), o = o.replace(/<(meta|script|link).+?>/gim, ""), o = o.replace(/<!--.*?-->/gm, ""), o = t ? o.replace(/\s?(class|style)=('|").+?('|")/gim, "") : o.replace(/\s?class=('|").+?('|")/gim, "")
        }
    }
    ...
    function Y(e, t) {
        ...
        this.id = "wangEditor-" + q++, this.toolbarSelector = e, this.textSelector = t, this.customConfig = {}
    }
        ...
        constructor: i, forEach: function (e) {
            ...
            return i = e.split(/\s+/), this.forEach(function (e) {
                i.forEach(function (i) {
                    if (i) {
                        if (L.push({elem: e, type: i, fn: n}), !t)return void e.addEventListener(i, n);
    ...
    s.prototype = {
        constructor: s, onClick: function (e) {
    ...
    l.prototype = {
        ...
        constructor: d, _command: function (e) {
    ...
    u.prototype = {
        constructor: u, show: function () {
            ...
            if (!(G.indexOf(t) >= 0)) {
                var n = t.editor, i = o("body"), A = n.$textContainerElem, r = this.opt, c = o('<div class="w-e-panel-container"></div>'), a = r.width || 300;
                ...
                h.forEach(function (e, t) {
                    ...
                    if (t) {
                        (t.events || []).forEach(function (t) {
                            var i = t.selector, o = t.type, A = t.fn || O;
                ...
                g.length && g.get(0).focus(), this.$container = c, this._hideOtherPanels(), G.push(t)
            }
        }, hide: function () {
            var e = this.menu, t = this.$container;
            t && t.remove(), G = G.filter(function (t) {
                return t !== e
            })
        ...
        constructor: h, onClick: function (e) {
            ...
            var n = this, i = c("input-link"), A = c("input-text"), r = c("btn-ok"), a = c("btn-del"), s = this._active ? "inline-block" : "none", l = new u(this, {
                width: 300,
                tabs: [{
                    title: "链接",
        ...
        constructor: p, onClick: function (e) {
            var t = this.editor, n = t.selection.isSelectionEmpty();
        ...
        constructor: f, onClick: function (e) {
        ...
        constructor: w, _command: function (e) {
        ...
        constructor: E, _command: function (e) {
        ...
        constructor: C, onClick: function (e) {
            var t = this.editor, n = t.selection.getSelectionStartElem(), i = t.selection.getSelectionEndElem(), A = t.selection.isSelectionEmpty(), r = t.selection.getSelectionText(), c = void 0;
            ...
            var t = this;
            e = e || "";
            var n = e ? "edit" : "new", i = c("texxt"), A = c("btn"), r = new u(this, {
                width: 500,
                tabs: [{
                    title: "插入代码",
        ...
        constructor: x, onClick: function () {
            this._createPanel()
        ...
        constructor: I, onClick: function () {
            ...
            var e = this, t = c("btn"), n = c("row"), i = c("col"), A = new u(this, {
                width: 250,
                tabs: [{
                    title: "插入表格",
        ...
        constructor: Q, onClick: function () {
            ...
            var e = this, t = c("text-val"), n = c("btn"), i = new u(this, {
                width: 350,
                tabs: [{
                    title: "插入视频",
        ...
        constructor: D, onClick: function () {
            ...
            }], r = new u(this, {width: 300, tabs: A});
            r.show(), this.panel = r
        }, _createInsertPanel: function () {
            var e = this.editor, t = e.uploadImg, n = e.config, i = c("up-trigger"), A = c("up-file"), r = c("link-url"), a = c("link-btn"), s = [{
                title: "上传图片",
    ...
    var $ = {};
    $.bold = s, $.head = d, $.link = h, $.italic = p, $.redo = f, $.strikeThrough = g, $.underline = m, $.undo = v, $.list = w, $.justify = b, $.foreColor = E, $.backColor = y, $.quote = B, $.code = C, $.emoticon = x, $.table = I, $.video = Q, $.image = D, k.prototype = {
        constructor: k,
        init: function () {
        ...
        constructor: N, init: function () {
            ...
            function e() {
                var e = Date.now(), t = !1;
                return e - r >= 500 && (t = !0), r = e, t
            }

            var t = this.editor, n = t.config, i = n.pasteFilterStyle, o = n.pasteTextHandle, A = t.$textElem, r = 0;
            A.on("paste", function (n) {
                if (!j.isIE() && (n.preventDefault(), e())) {
                    var A = _(n, i), r = M(n);
                    r = r.replace(/\n/gm, "<br>"), o && "function" == typeof o && (A = "" + (o(A) || ""), r = "" + (o(r) || ""));
                    var c = t.selection.getSelectionContainerElem();
                    if (c) {
                        var a = c.getNodeName();
                        if ("CODE" === a || "PRE" === a)return void t.cmd.do("insertHTML", "<p>" + r + "</p>");
                        if (A)try {
                            t.cmd.do("insertHTML", A)
                        } catch (e) {
                            t.cmd.do("insertHTML", "<p>" + r + "</p>")
                        }
                    }
                }
            }), A.on("paste", function (n) {
                if (!j.isIE() && (n.preventDefault(), e())) {
                    var i = U(n);
                    if (i && i.length) {
                        var o = t.selection.getSelectionContainerElem();
                        if (o) {
                            var A = o.getNodeName();
                            if ("CODE" !== A && "PRE" !== A) {
                                t.uploadImg.uploadImg(i)
                            }
                        }
                    }
                }
            ...
            t.on("click", "img", function (t) {
                var n = this, i = o(n);
                e._selectedImg = i, e.selection.createRangeByElem(i), e.selection.restoreSelection()
    ...
    H.prototype = {
        constructor: H, _alert: function (e, t) {
            ...
            var t = this;
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgServer, c = i.uploadImgShowBase64, a = i.uploadImgMaxSize, s = a / 1e3 / 1e3, l = i.uploadImgMaxLength || 1e4, d = i.uploadFileName || "", u = i.uploadImgParams || {}, h = i.uploadImgParamsWithUrl, p = i.uploadImgHeaders || {}, f = i.uploadImgHooks || {}, g = i.uploadImgTimeout || 3e3, m = i.withCredentials;
                null == m && (m = !1);
                ...
                if (v || o || c) {
                    ...
                    if (r(e, function (e) {
                            ...
                            if (t && n)return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void b.push("【" + t + "】不是图片") : a < n ? void b.push("【" + t + "】大于 " + s + "M") : void w.push(e)
                    ...
                    if (r(w, function (e) {
                        ...
                        if (C.open("POST", o), C.timeout = g, C.ontimeout = function () {
                                ...
                                if (4 === C.readyState) {
                                    ...
                                    if (e = C.responseText, "object" !== (void 0 === e ? "undefined" : W(e)))try {
                                        e = JSON.parse(e)
                                    } catch (i) {
                            ...
                            var x = f.before(C, n, w);
                            if (x && "object" === (void 0 === x ? "undefined" : W(x)) && x.prevent)return void this._alert(x.msg)
                        }
    ...
    Y.prototype = {
        constructor: Y, _initConfig: function () {
            var e = {};
            this.config = Object.assign(e, P, this.customConfig);
            var t = this.config.lang || {}, n = [];
            A(t, function (e, t) {
                n.push({reg: new RegExp(e, "img"), val: t})
            }), this.config.langArgs = n
        }, _initDom: function () {
            var e = this, t = this.toolbarSelector, n = o(t), i = this.textSelector, A = this.config, r = A.zIndex, a = void 0, s = void 0, l = void 0, d = void 0;
            ...
            a.attr("id", u);
            var h = c("text-elem");
            l.attr("id", h), this.$toolbarElem = a, this.$textContainerElem = s, this.$textElem = l, this.toolbarElemId = u, this.textElemId = h, s.on("click keyup", function () {
                e.change && e.change()
            }), a.on("click", function () {
