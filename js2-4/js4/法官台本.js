...
$(document).ready(function (){
    ...
    $("#step2").click(function (){
        if(btn === (2+day*4)){
            ...
            $(".triangle2").css({"border-right":"15px solid #f0f0f0"});
            alert("请进入下一环节");
            btn++;
        }
        else{
    ...
    $("#step3").click(function (){
        if(btn == (3+day*4)){
            $(this).css({"background-color":"#f0f0f0"});
            $(".triangle3").css({"border-right":"15px solid #f0f0f0"});
            alert("请进入下一环节");
            btn++;
        }
        else{
    ...
    $("#step4").click(function (){
        if(btn == (4+day*4)){
            $(this).css({"background-color":"#f0f0f0"});
            $(".triangle4").css({"border-right":"15px solid #f0f0f0"});
            window.location.href = "杀人+投票.html";
            btn++;
            day++;
...
$(document).ready(function (){
    if(btn == (2+day*4)){
        $("#step1").css({"background-color":"#f0f0f0"});
        $(".triangle1").css({"border-right":"15px solid #f0f0f0"});
...
$(document).ready(function (){//复制生成块
    ...
    for(var o=0;o<day;o++){
        console.log(day,o);
        $(".day").eq(o).find(".column-2").css({"background-color":"#f0f0f0"});
        $(".day").eq(o).find(".column-1").css({"border-right":"15px solid #f0f0f0"});
    }
});
